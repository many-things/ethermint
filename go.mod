...
replace (
	// v0.12.0 is not compatible with cosmos-sdk v0.50.x
	...
	github.com/ethereum/go-ethereum => github.com/many-things/go-ethereum v1.10.20-0.20240124035840-d957a3a419b5
