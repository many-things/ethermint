...
// BeginBlocker updates base fee
func (k *Keeper) BeginBlocker(rawCtx context.Context) error {
...
// EndBlocker update block gas wanted.
// The EVM end block logic doesn't update the validator set, thus it returns
// an empty slice.
func (k *Keeper) EndBlocker(rawCtx context.Context) error {
	ctx := sdk.UnwrapSDKContext(rawCtx)
